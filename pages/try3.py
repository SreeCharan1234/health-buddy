...
if selected == 'Diabetes Prediction':
    ...
    if st.button("Diabetes Test Result"):
        ...
        if prediction[0]==1:
            ...
            text=get_gemini_response("the person had diabetic now tell me some 5 parts 1 percatuition and what to eat ")
        else:
...
if selected == 'Heart Disease Prediction':
    ...
    if st.button("Heart Disease Test Result"):
        ...
        if prediction[0]==1:
            ...
            text=get_gemini_response("the person having heart disease now tell me some 5 parts 1 percatuition and 2 what to eat 3 execersice  4  ")
        else:
...
if selected == 'Kidney Disease Prediction':
    ...
    kidney_disease_model=joblib.load("pages/kidney_new.pkl")
